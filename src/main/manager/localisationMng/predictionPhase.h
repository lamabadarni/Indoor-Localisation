 ...
 * @brief Prediction system interface for computing locations using RSSI kNN models.
 *
...
/**
 * @brief this function predicts the current label based on RSSI values a ccumualted in real time.
 */
